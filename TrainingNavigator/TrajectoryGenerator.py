...
if __name__ == "__main__":
    workspaces_file_path = "workspaces/20x20maze.npy"  # path of numpy file with workspaces
    workspaces_filename = workspaces_file_path.split("/")[-1].split(".")[0]

    trajs_filename = "20x20maze"
    plots_save_path = "workspaces/20x20maze_plots/"  # path to save plots
    Path(plots_save_path).mkdir(parents=True, exist_ok=True)

    # create Search Space
    map_path = "maps/20x20maze_freespace.png"
